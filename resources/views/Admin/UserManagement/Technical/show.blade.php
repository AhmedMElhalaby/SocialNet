                                ...
                                <div class="card-content table-responsive">
                                    <table class="table table-hover">
                                        ...
                                        <tr>
                                            ...
                                            <td style="border-top: none !important;"><a href="{{url('app_content/orders?technical_id='.$Object->getId())}}">{{\App\Models\Order::where('technical_id',$Object->getId())->count()}}</a></td>
                                        </tr>
                                    </table>
                                </div>
                            </div>
